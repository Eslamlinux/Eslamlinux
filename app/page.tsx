...
import { Github, Twitter, Linkedin, Mail, Menu } from "lucide-react"
  ...
  return (
    <div className="min-h-screen bg-[#1a1a1a] text-white">
          ...
          <div className="flex flex-col md:flex-row items-center">
            <div className="md:w-1/2 mb-8 md:mb-0">
              <h1 className="text-4xl md:text-5xl font-bold mb-4 text-[#00ff00]">
                مرحباً بكم في موقع <span className="text-white">EslamLinux</span>
              </h1>
              <p className="text-xl mb-6 text-gray-300">مطور ويب ومتخصص في لينكس وأمن المعلومات</p>
              <div className="flex space-x-4 rtl:space-x-reverse">
                <Button className="bg-[#00ff00] text-black hover:bg-[#00cc00]">تواصل معي</Button>
                <Button
                  variant="outline"
      ...
      <section className="py-16 bg-[#1a1a1a]">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-12 text-center text-[#00ff00]">المهارات التقنية</h2>
      ...
      <section className="py-16 bg-[#222] border-y border-[#333]">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-12 text-center text-[#00ff00]">أحدث المشاريع</h2>
            ...
            {[1, 2, 3].map((i) => (
              ...
              >
                <div className="h-48 bg-[#333]">
                  <img
                    src={`/placeholder.svg?height=200&width=400&text=مشروع ${i}`}
                    alt={`مشروع ${i}`}
                    className="w-full h-full object-cover"
                  />
                </div>
                <CardContent className="p-6">
                  <h3 className="text-xl font-bold mb-2 text-[#00ff00]">مشروع لينكس {i}</h3>
          ...
          <div className="text-center mt-10">
            <Button className="bg-[#00ff00] text-black hover:bg-[#00cc00]">عرض جميع المشاريع</Button>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#1a1a1a]">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-12 text-center text-[#00ff00]">أحدث المقالات</h2>
              ...
              <Card key={i} className="bg-[#222] border-[#333] hover:border-[#00ff00] transition-colors">
                <CardContent className="p-6">
                  <div className="flex items-center mb-4">
                    ...
                    <div>
                      <h3 className="text-xl font-bold text-[#00ff00]">عنوان المقال {i}</h3>
                      <p className="text-gray-400 text-sm">{new Date().toLocaleDateString("ar-EG")}</p>
                    </div>
                  </div>
                  <p className="text-gray-300 mb-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="text-gray-400 text-sm">5 دقائق للقراءة</div>
                  </div>
                </CardContent>
              </Card>
            ))}
          ...
          <div className="text-center mt-10">
            <Button className="bg-[#00ff00] text-black hover:bg-[#00cc00]">عرض جميع المقالات</Button>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-[#222] border-t border-[#333]">
        <div className="container mx-auto px-4">
          <h2 className="text-3xl font-bold mb-12 text-center text-[#00ff00]">تواصل معي</h2>
          <div className="flex flex-col md:flex-row gap-8">
            <div className="md:w-1/2">
              <form className="space-y-4">
                ...
                <Button className="bg-[#00ff00] text-black hover:bg-[#00cc00] w-full">إرسال الرسالة</Button>
              </form>
            </div>
            <div className="md:w-1/2">
              <div className="bg-[#1a1a1a] border border-[#333] rounded-md p-6 h-full">
                <h3 className="text-xl font-bold mb-6 text-[#00ff00]">معلومات التواصل</h3>
                ...
                <div className="mt-8">
                  <h3 className="text-xl font-bold mb-4 text-[#00ff00]">تابعني</h3>
